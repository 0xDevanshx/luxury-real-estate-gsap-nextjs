      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-24">
          <div className="lg:w-1/3 flex flex-col items-start">
            ...
            >
              <Building2
                className="w-8 h-8 group-hover:text-white/80 transition-colors"
                strokeWidth={1.5}
              />
              <span className="text-2xl font-medium tracking-[0.2em] uppercase">
                LuxeEstates
              </span>
            </Link>
            <p className="text-white/60 font-light leading-relaxed max-w-sm mb-8">
              Curating the world&apos;s most exceptional properties for those
              who demand the extraordinary. Redefining modern luxury living
              since 1998.
            </p>
          ...
          <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-8">
            <div className="flex flex-col gap-4">
              <h4 className="text-sm font-bold tracking-widest uppercase text-white/40 mb-2">
                Portfolio
              </h4>
              <Link
                href="#"
                className="text-white/70 hover:text-white font-light transition-colors"
              >
                Residential
              </Link>
              <Link
              ...
              <Link
                href="#"
                className="text-white/70 hover:text-white font-light transition-colors text-lg"
              >
                Residential
              </Link>
              <Link
        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-t border-white/10 pt-8 gap-6">
          <p className="text-white/40 text-sm font-light text-center md:text-left">
            &copy; {new Date().getFullYear()} Luxe Estates International. All
            rights reserved.
          </p>
