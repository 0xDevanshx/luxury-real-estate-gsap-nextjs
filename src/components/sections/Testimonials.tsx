...
const TESTIMONIALS = [
  ...
  },
  {
    id: 2,
    quote:
      "Every detail felt intentional, from the first viewing to the final signature.",
  ...
  },
  {
    id: 4,
    quote:
      "We explored dozens of properties, but only one truly felt like home.",
  ...
  },
  {
    id: 5,
    quote:
      "Their market knowledge gave us confidence throughout the entire process.",
    author: "James Foster",
  ...
  },
  {
    id: 7,
    quote:
      "The experience was seamless, sophisticated, and completely stress-free.",
    author: "Ethan Brooks",
    title: "CEO",
  },
  {
        ...
        <div className="w-[100vw] relative">
          ...
          >
            {TESTIMONIALS.map((testimonial) => (
              <SwiperSlide
                key={testimonial.id}
                className="!w-[85vw] md:!w-[60vw] max-w-[800px]"
              >
                {({ isActive }) => (
                  <div
