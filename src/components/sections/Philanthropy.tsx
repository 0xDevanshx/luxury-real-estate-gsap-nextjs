...
export default function Philanthropy() {
  ...
  useEffect(() => {
    ...
    const splitText = new SplitType(textRef.current, {
      types: "words",
      wordClass: "will-change-transform inline-block",
    });
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full h-[80vh] md:h-[90vh] bg-black text-white flex items-center justify-center overflow-hidden z-10"
    >
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center flex flex-col items-center">
        ...
        <div className="max-w-2xl mx-auto w-full mb-16">
          ...
          >
            We believe true luxury is leaving the world better than we found it.
            A portion of every transaction funds sustainable housing initiatives
            in developing nations, creating lasting legacies of shelter and
            hope.
          </p>
        </div>
        ...
        >
          <Play
            size={32}
            className="text-white group-hover:text-black transition-colors duration-500 ml-2"
            strokeWidth={1}
          />
