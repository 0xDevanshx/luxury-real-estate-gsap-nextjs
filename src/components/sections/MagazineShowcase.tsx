        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-24 gap-8 text-center md:text-left">
          <div className="max-w-xl">
            ...
            <p className="text-white/60 text-lg font-light leading-relaxed">
              Explore our exclusive quarterly publication featuring unseen
              properties, architectural deep dives, and global design trends.
            </p>
          </div>
          <div>
            <Link
          ...
          {MAGAZINES.map((mag) => (
            <div
              ...
              style={{
                ...
                animationDelay:
                  mag.id === 1 ? "0s" : mag.id === 2 ? "0.4s" : "0.8s",
