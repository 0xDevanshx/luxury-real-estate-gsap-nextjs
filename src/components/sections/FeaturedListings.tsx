  ...
  return (
    <div id="search" className="w-full">
      ...
      <div className="absolute top-24 left-6 lg:left-12 z-20 pointer-events-none mix-blend-difference">
        {/* DO NOT MODIFY POSITION. Only increased font size (md:text-7xl) as requested. */}
        <h2 className="text-4xl md:text-7xl font-bold uppercase tracking-tighter leading-none">Exclusive<br/>Listings</h2>
      ...
      {/* 
        Wrap the entire card composition inside a constrained container (max-w-[1440px]).
        This ensures the overlap and spacing remains visually identical on all large screens.
      */}
